...
base='http://www.jafaer-tv.com'
ADDON=xbmcaddon.Addon(id='plugin.video.jafaer')# changes
...
def CATEGORIES():
    link = OPEN_URL('http://www.jafaer-tv.com/kodi/wizard0.4.txt').replace('\n','').replace('\r','')# changes
...
def wizard(name,url,description):
    ...
    dp.create("Jafaer-tv Wizard","Downloading ",'', 'Please Wait')
